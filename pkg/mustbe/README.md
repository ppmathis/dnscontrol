...
- Any IDNA (PunyCode) conversions must be done here. Only ASCII is stored in fields that hold hostnames.
- Any hostnames must be extended to their FQDN, including a trailing dot (if required).
